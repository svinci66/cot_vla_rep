...
# Recreate the VILA-U training environment on a server that cannot access the
# original /data/share/.../vila_env_fixed directory. This installs dependencies
# from public package indexes and the current repo, not from that environment.
