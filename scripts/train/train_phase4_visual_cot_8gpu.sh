...
export USE_VISUAL_CHANGE_WEIGHT=${USE_VISUAL_CHANGE_WEIGHT:-True}
export VISUAL_CHANGE_WEIGHT_MODE=${VISUAL_CHANGE_WEIGHT_MODE:-dynamic}
export VISUAL_CHANGE_WEIGHT=${VISUAL_CHANGE_WEIGHT:-10.0}
export VISUAL_CHANGE_INTENSITY_THRESHOLD=${VISUAL_CHANGE_INTENSITY_THRESHOLD:-0.1}
export VISUAL_UNCHANGED_WEIGHT=${VISUAL_UNCHANGED_WEIGHT:-0.5}
